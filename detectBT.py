...
import sys
sys.path.insert(1, 'D:/BT/CNN/')
import model
sys.path.insert(1, 'D:/BT/ImageSegmentation/')
import model_bt

image_path = 'D:/BT/imgForTest/t (5).jpg'
cnn_weight = 'D:/BT/CNN/Model/weights.hdf5'
unet_weight = 'D:/BT/ImageSegmentation/Model/weights.hdf5'
...
if pd_cnn[0][0] > 0.5:
    ...
    file_name = image_path.replace("D:/BT/imgForTest/", "")
    file_name = file_name.replace(".jpg", "")
    cv2.imwrite('D:/BT/imgForTest/{}predicted.png'.format(file_name),
                add)   
else:
